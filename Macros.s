...
.macro DesenharFundo()
	...
	add a0, a0, a4 #a0 = endereco do endereï¿½o fundo a ser renderizado
	lw a0,(a0) #a0 = endereï¿½o do fundo
...
.macro PlayMusic(%Musica)
	...
	lw a5, (a5) #a5 = Tempo de inicio da prï¿½xima nota
	blt a0, a5, Skip #Checa se jï¿½ ï¿½ hora de tocar a nota
	...
	j Skip
NotNegative: 
	beq a0, zero, Pause #Checa se ï¿½ uma pausa
...
.macro IA()    # IAinimigo -flag- aproximar, afastar, ataque alto, ataque baixo , defesa  , Distancias de aproximar devem ser testadas depois
	...
	#D1  		IA 1 - Se aproxima atÃ© 80, se afasta a partir de 50 ,sempre ataca alto entre as duas distancias
	sub a3,a2,a1
...
PertoD2:li a0,45
	ble a3,a0,AfastarD2    
	li a7,40   #seta nvoa seed randÃ´mica
	ecall 
	li a1,1
	li a7,42
